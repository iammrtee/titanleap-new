const cards = [
  { n:'01', title:'Audit-First', p:"Every engagement starts with data, not assumptions. We map your funnel, traffic, and conversion points before recommending a single fix.", source:'Free Revenue Leak Audit · 5-hour delivery' },
