      ...
      <div className="wrap">
        <div className="ft-grid">
          <div>
            ...
            <p className="ft-about" style={{marginTop:'16px'}}>Done-for-you growth systems for early-stage SaaS founders. We build the machine — you run the business. Working with founders globally.</p>
          </div>
        ...
        <div className="ft-bottom">
          <span className="ft-copy">© 2026 TitanLeap · titanleap.co · All rights reserved. · <a href="/policy">Privacy Policy</a></span>
          <span className="ft-copy">Built for founders, by a founder</span>
        </div>
      </div>
    </footer>
  )
